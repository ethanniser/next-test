...
import { type RouteType as Route_1 } from "./src/app/[id]/routeType";
import { type RouteType as Route_2 } from "./src/app/_oldIndex/routeType";
import type { InferRoute, StaticRoute } from "next-typesafe-url";

declare module "@@@next-typesafe-url" {
  interface DynamicRouter {
    "/": InferRoute<Route_0>;
    "/[id]": InferRoute<Route_1>;
    "/_oldIndex": InferRoute<Route_2>;
  }
